...
import zombie.plz.PLZConductWatch;
...
public class PVPLogTool {
    ...
    public static void logKill(IsoPlayer wielder, IsoPlayer target) {
        ...
        // PLZ: vanilla's copy of this lands in pvp.txt, which ZLogger empties
        // once it passes 10MB. See zombie.plz.PLZConductWatch.
        PLZConductWatch.onKill(wielder, target);
    }
    ...
    public static void logCombat(
        ...
        // PLZ: the durable copy. Zombie and animal hits reach here too and are
        // dropped inside the hook. See zombie.plz.PLZConductWatch.
        PLZConductWatch.onCombat(wielder, target, weapon, damage, x, y, z);
    }
