...
public class SyncZonePacket implements INetworkPacket {
    ...
    @JSONField
    boolean zoneAdded;
    private zombie.plz.PLZAnimalZoneGate.Refusal plzRefusal;
    ...
    public void parseServer(ByteBufferReader b, UdpConnection connection) {
        // PLZ: decided before parse, because DesignationZone.load applies a rename while it reads.
        this.plzRefusal = zombie.plz.PLZAnimalZoneGate.review(b, connection);
        if (this.plzRefusal == null) {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        if (this.plzRefusal != null) {
            zombie.plz.PLZAnimalZoneGate.restore(this.plzRefusal, connection);
            this.plzRefusal = null;
            return;
        }
