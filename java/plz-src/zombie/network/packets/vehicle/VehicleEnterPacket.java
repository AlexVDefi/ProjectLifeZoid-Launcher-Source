...
import zombie.plz.PLZVehicleSeatWatch;
...
public class VehicleEnterPacket implements INetworkPacket {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        ...
        // PLZ: the only server-side notice that anybody boarded a vehicle.
        // OnEnterVehicle is client-gated and never fires here. See
        // zombie.plz.PLZVehicleSeatWatch.
        PLZVehicleSeatWatch.onSeated(this.vehicleId.getVehicle(), this.playerId.getPlayer(), this.seatTo);
    }
}
