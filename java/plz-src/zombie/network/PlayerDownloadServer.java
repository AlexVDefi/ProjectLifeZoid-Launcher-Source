...
public final class PlayerDownloadServer {
    ...
    public ClientChunkRequest getClientChunkRequest(boolean isLargeArea) {
        // PLZ: every chunk-request wave marks this connection as actively streaming, so a client
        // on a slow link is never reaped mid-load. See PLZStalledConnections.noteChunkActivity.
        zombie.plz.PLZStalledConnections.noteChunkActivity(this.connection);
