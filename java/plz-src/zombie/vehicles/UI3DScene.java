...
public final class UI3DScene extends UIElement {
    ...
    public Object fromLua1(String func, Object arg0) {
        switch (func) {
            ...
            case "getVehicleSkinCount": {
                UI3DScene.SceneVehicle vehicle = this.getSceneObjectById((String)arg0, UI3DScene.SceneVehicle.class, true);
                return BoxedStaticValues.toDouble(vehicle.script == null ? 0.0 : (double)vehicle.script.getSkinCount());
            }
    ...
    public Object fromLua2(String func, Object arg0, Object arg1) {
        switch (func) {
            ...
            case "setVehicleSkinIndex": {
                ...
                if (index != vehicle.skinIndex) {
                    vehicle.skinIndex = index;
                    vehicle.resetModels();
                }
    ...
    public Object fromLua4(String func, Object arg0, Object arg1, Object arg2, Object arg3) {
        switch (func) {
            case "setVehiclePaintColor": {
                UI3DScene.SceneVehicle vehicle = this.getSceneObjectById((String)arg0, UI3DScene.SceneVehicle.class, true);
                float h = arg1 == null ? 0.0F : ((Double)arg1).floatValue();
                float sat = arg2 == null ? 0.0F : ((Double)arg2).floatValue();
                float v = arg3 == null ? 0.0F : ((Double)arg3).floatValue();
                vehicle.paint.set(PZMath.clamp(h, 0.0F, 1.0F), PZMath.clamp(sat, 0.0F, 1.0F), PZMath.clamp(v, 0.0F, 1.0F));
                return null;
            }
            case "clearGeometry": {
                String modID = (String)arg0;
    ...
    private static final class SceneVehicle extends UI3DScene.SceneObject {
        ...
        UI3DScene.SceneObjectRenderData renderMain() {
            ...
            if (!this.init) {
                ...
                if (this.script.getSkinCount() > 0) {
                    modelInfo.tex = Texture.getSharedTexture("media/textures/" + this.script.getSkin(this.clampedSkinIndex()).texture + ".png");
                }
        ...
        int clampedSkinIndex() {
            if (this.script == null || this.script.getSkinCount() <= 0) {
                return 0;
            }
            return PZMath.clamp(this.skinIndex, 0, this.script.getSkinCount() - 1);
        }
            ...
            if (Core.debug && DebugOptions.instance.model.render.wireframe.getValue()) {
                ...
                if (effect != null && effect.isVehicleShader()) {
                    ...
                    if (tex != null) {
                        ...
                        int skin = this.vehicle.clampedSkinIndex();
                        if (this.vehicle.script.getSkinCount() > 0 && this.vehicle.script.getSkin(skin).textureMask != null) {
                            Texture textureMask = Texture.getSharedTexture("media/textures/" + this.vehicle.script.getSkin(skin).textureMask + ".png");
                    ...
                    effect.setTexturePainColor(this.vehicle.paint, 1.0F);
                    if (model.isStatic) {
                        effect.setTransformMatrix(IDENTITY.identity(), false);
                    } else {
                        effect.setMatrixPalette(modelRenderData.matrixPalette, true);
