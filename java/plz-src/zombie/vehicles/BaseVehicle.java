...
public final class BaseVehicle
    ...
    public void permanentlyRemove() {
        ...
        // PLZ: the only notification Lua gets that a vehicle is gone for good.
        // Everything that destroys a vehicle ends up here, and B42 fires no event
        // of its own, so a mod tracking vehicles was left inferring it from
        // getVehicleById returning null - which is equally true of a car parked in
        // an unloaded chunk. See zombie.plz.PLZVehicleWatch.
        PLZVehicleWatch.onPermanentlyRemoved(this);
