...
public abstract class IsoGameCharacter
    ...
    public void hitConsequences(HandWeapon weapon, IsoGameCharacter wielder, boolean bIgnoreDamage, float damage, boolean bRemote) {
        ...
        zombie.plz.PLZDowned.enforce(this);
    ...
    private boolean isPLZEscortGrapple() {
        return "PLZEscort".equals(this.getSharedGrappleType());
    }

    public void throwGrappledTargetOutWindow(IsoObject windowObject) {
        if (this.isPLZEscortGrapple()) {
            return;
        }
    ...
    public static void plzSetDowned(String username, boolean value) {
        zombie.plz.PLZDowned.setDowned(username, value);
    }

    public static boolean plzIsDowned(String username) {
        return zombie.plz.PLZDowned.isDowned(username);
    }

    public static int plzDownedCount() {
