...
import zombie.plz.PLZScriptText;
...
public final class ScriptParser {
    ...
    public static String stripComments(String totalFile) {
        if (PLZPerf.SCRIPT_PARSER_FAST) {
            String fast = PLZScriptText.stripComments(totalFile);
            if (fast != null) {
                return fast;
            }
        }
    ...
    public static ArrayList<String> parseTokens(String totalFile) {
        if (PLZPerf.SCRIPT_PARSER_FAST) {
            return PLZScriptText.parseTokens(totalFile);
        }
