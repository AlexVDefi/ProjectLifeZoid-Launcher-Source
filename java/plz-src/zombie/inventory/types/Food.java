    ...
    public boolean checkEggHatch(IsoHutch hutch) {
        ...
        if (!StringUtils.isNullOrEmpty(this.animalHatch)) {
            ...
            if (this.fertilizedTime >= this.timeToHatch) {
                ...
                // PLZ: the chick takes the farm off the egg it came out of. The hen
                // stamped it in IsoAnimal.createEgg, possibly days ago and possibly
                // before she was sold - the egg is the only thing that spans the two
                // moments, and attachBackToMother above is an animalId, which collides.
                PLZAnimalOwner.hatch(this, baby);
