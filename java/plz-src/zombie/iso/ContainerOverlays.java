...
import zombie.plz.PLZShelfOverlay;
...
public class ContainerOverlays {
    ...
    public void updateContainerOverlaySprite(IsoObject obj) {
        // PLZ: a shelf a shopkeeper has dressed keeps the look they chose. Without this, an owner
        // moving anything through the shelf strips it, and any shelf still holding loot has the
        // choice overwritten by the pick below on every chunk load. See PLZShelfOverlay.
        if (PLZShelfOverlay.isManaged(obj)) {
            return;
        }
