...
public class IsoPhysicsObject extends IsoMovingObject {
    ...
    public void update() {
        ...
        // PLZ: vanilla hardcodes 10 for the server here, so fpsMod (30/fps, the per-step
        // velocity decay) would stay tuned for 10 TPS even if the loop ran faster - physics would
        // decay twice as much per second at 20 TPS. Read the configured rate instead.
        int fps = GameServer.server ? zombie.plz.PLZTickRate.serverFps() : PerformanceSettings.getLockFPS();
